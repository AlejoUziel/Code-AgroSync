...
const estadoConfig: Record<string, { color: string; dot: string }> = {
  "Activa": { color: "bg-[#F0F5EA] text-[#8EBF24] border-0", dot: "bg-[#8EBF24]" },
      ...
      <div className="space-y-5">
        ...
        <div className="bg-white rounded-xl border border-[#E2EDD6]">
          ...
          <div className="flex items-center gap-3 p-4 border-b border-[#E2EDD6]">
            ...
            <button className="flex items-center gap-2 px-3 py-2 rounded-lg border border-[#E2EDD6] text-xs font-body text-[#6B7280] hover:border-[#8EBF24]/40 hover:text-[#1E1E1E] transition-all">
            ...
            <table className="w-full">
              ...
              <tbody>
                {parcelas.map((p, i) => (
                  <tr
                    key={p.id}
                    className="border-b border-[#F0F5EA] hover:bg-[#F9FBF6] transition-colors group"
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <div className="w-6 h-6 rounded-md bg-[#8EBF24]/10 flex items-center justify-center">
                          <MapPin size={11} className="text-[#8EBF24]" />
                        </div>
                    ...
                    <td className="px-4 py-3 w-32">
                      <div className="flex items-center gap-2">
                        <Progress value={p.progreso} className="h-1.5 flex-1 bg-[#E2EDD6]" />
                    ...
                    <td className="px-4 py-3">
                      <button className="opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded-md hover:bg-[#F0F5EA] text-[#9CA3AF] hover:text-[#1E1E1E]">
              ...
              {[1, 2, 3, "...", 8].map((p, i) => (
                <button
                  ...
                  className={`w-7 h-7 rounded-md text-xs font-body transition-colors ${
                    p === 1
                      ? "bg-[#8EBF24] text-white"
                      : "text-[#6B7280] hover:bg-[#F0F5EA]"
                  }`}
                >
                  {p}
                </button>
