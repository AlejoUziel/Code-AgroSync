...
const estadoConfig: Record<string, string> = {
  "Completada": "bg-secondary text-primary border-0",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-card rounded-xl border border-border p-5">
            ...
            <div className="text-center py-4">
              ...
              <p className="font-body text-[11px] text-primary mt-1">+8.3% vs meta mensual</p>
            </div>
            <div className="space-y-2 mt-2">
              {[
                ...
                <div key={item.label}>
                  ...
                  <Progress value={item.pct} className="h-1.5 bg-card" />
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="bg-card rounded-xl border border-border">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {cosechas.map((c) => (
                  <tr key={c.id} className="border-b border-secondary hover:bg-background transition-colors group">
                    ...
                    <td className="px-4 py-3">
                      {c.calidad !== "—" ? (
                        <Badge className={`text-[10px] px-2 py-0.5 border-0 ${c.calidad === "Premium" ? "bg-purple-50 text-purple-600" : "bg-secondary text-primary"}`}>{c.calidad}</Badge>
