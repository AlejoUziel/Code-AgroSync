    ...
    <div className="relative">
      ...
      <input
        className={cn(
          ...
          "disabled:bg-background disabled:text-[#9CA3AF] disabled:cursor-not-allowed",
          error
...
export function FormSection({
  ...
  return (
    <div className={cn("space-y-3", className)}>
      <h3 className="font-heading text-xs text-[#9CA3AF] uppercase tracking-wider border-b border-border pb-2">
        {title}
      </h3>
      {children}
    </div>
...
export function ConfirmDeleteDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-sm border-border bg-card p-0 overflow-hidden">
...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 gap-3 text-center">
      <div className="w-14 h-14 rounded-2xl bg-secondary flex items-center justify-center text-primary mb-1">
        {icon}
      </div>
  ...
  return (
    <div
      className={cn(
        ...
        type === "success"
          ? "bg-card border-primary/30 text-[#1E1E1E]"
